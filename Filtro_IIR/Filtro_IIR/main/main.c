...
#define Fs  48000.0                 // frecuencia de muestreo de la señal a fitrar
#define N_periodos_test 5           // cantidad de periodos para el test unitario
...
const struct filtro_IIR_2ord etapa_0 = {.b_0 = 1.000021338462830, .b_1 = -2, .b_2 = 1.000021338462830, .a_1 = -1.999893784523010, .a_2 = 0.999935925006867, .k_f = 0.0000005791732746729394};
const struct filtro_IIR_2ord etapa_1 = {.b_0 = 1.000021457672119, .b_1 = -2, .b_2 = 1.000021457672119, .a_1 = -1.999891281127930, .a_2 = 0.999934792518616, .k_f = 1};
const struct filtro_IIR_2ord etapa_2 = {.b_0 = 1.000021457672119, .b_1 = -2, .b_2 = 1.000021457672119, .a_1 = -1.999827861785889, .a_2 = 0.999870777130127, .k_f = 1};
const float k_salida = 1.726264875*1000000; // constante de salida del filtro (cuarto valor de escala de la matriz SOS)
...
void test_unitario_filtro(void){
    ...
    float frecuencias[23] = {47.000000, 48.000000, 49.000000, 49.200000, 49.400000, 49.600000, 49.700000, 49.800000, 49.850000, 49.900000, 49.950000, 50.000000, 50.050000, 50.100000, 50.150000, 50.200000, 50.300000, 50.400000, 50.600000, 50.800000, 51.000000, 52.000000, 53.000000};
    float dB_ideal[23] = {-0.139634, -0.223699, -0.567321, -0.885751, -2.049284, -8.007648, -15.732472, -28.792566, -39.621588, -67.563333, -56.261444, -63.416721, -104.629457, -52.250306, -36.895746, -27.205495, -14.655357, -7.224630, -1.573171, -0.424280, -0.120204, 0.074168, 0.070265};
    
    float dB_test[sizeof(frecuencias)]; // para guardar la respuesta de nuestro filtro y compararlo con el ideal
